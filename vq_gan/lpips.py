...
class LPIPS(nn.Module):
    def __init__(self, vgg_lpips_path):
        ...
        self.load_from_pretrained(vgg_lpips_path)

        for param in self.parameters():
            param.requires_grad = False

    def load_from_pretrained(self, vgg_lpips_path):
        self.load_state_dict(torch.load(vgg_lpips_path, map_location=torch.device("cpu")), strict=False)
